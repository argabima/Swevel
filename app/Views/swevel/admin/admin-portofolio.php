            ...
            <div class="card h-100 border-0">
                <div class="card-body">
                    ...
                    <?php foreach ($portofolio as $x) : ?>
                        <?php if (isset($x['image'], $x['judul'], $x['id'])) : ?>
                            <div class="col-12 col-md-4 mb-4 card-portofolio" data-bs-toggle="modal" data-bs-target="#modal-view-portofolio">
                                ...
                                <div class="d-flex">
                                    <div class="text-start"><button type="button" class="btn btn-purple btn-sm mt-3 hide btn-delete-portofolio" data-id="<?= $x['id']; ?>" data-image="<?= $x['image']; ?>" data-bs-toggle="modal" data-bs-target="#modalDeletePortofolio">Hapus</button></div>
                                    <div class="text-start ms-2"><button type="button" class="btn btn-purple btn-sm mt-3 hide btn-edit-portofolio" data-id="<?= $x['id']; ?>" data-image="<?= $x['image']; ?>" data-judul="<?= $x['judul']; ?>" data-bs-toggle="modal" data-bs-target="#none">Edit</button></div>
                                </div>
                            </div>
                            <?php else : ?>
                                <div class="col-12 col-md-4 mb-4">Data tidak tersedia</div>
                            <?php endif; ?>
                        <?php endforeach; ?>
                    </div>
                </div>

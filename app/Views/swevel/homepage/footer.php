        ...
        <div class="row">
            ...
            <div class="col-lg-2">
                <ul class="list-unstyled" id="link">
                    <li><a class="text-decoration-none text-dark" href="#about-us">Tentang</a></li>
                    <li><a class="text-decoration-none text-dark" href="#service">Layanan</a></li>
                    <li><a class="text-decoration-none text-dark" href="#course">Kursus</a></li>
                    <li><a class="text-decoration-none text-dark" href="#portofolio">Portofolio</a></li>
                    <li><a class="text-decoration-none text-dark" href="#customer-review">Ulasan</a></li>                    
                    <li><a class="text-decoration-none text-dark" href="#contactUs">Kontak</a></li>
                </ul>
            </div>
